...
export function Sidebar({ isAdmin, canManageInstallationProjects, logoUrl, businessName }: SidebarProps) {
  return (
    <aside className="hidden w-64 shrink-0 flex-col bg-brand-green lg:flex">
      ...
      <div className="flex-1 overflow-y-auto px-3 py-4">
        <NavList isAdmin={isAdmin} canManageInstallationProjects={canManageInstallationProjects} />
      </div>
